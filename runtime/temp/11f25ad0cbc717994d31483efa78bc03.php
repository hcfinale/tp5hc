<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"./tpl\admin\authority\edit.html";i:1516582903;}*/ ?>
<!DOCTYPE html>
<html>
...
<form action="<?php echo url('Authority/edit'); ?>" method="post" role="form">
    ...
    <div class="container" style="margin-top: 3rem;">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-sm-9">
                <input type="text" name="title" class="form-control" placeholder="请输入模块名称如(前台首页)" value="<?php echo $request['title']; ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="center-block" style="width:200px;">
                <input type="submit" value="提交" class="btn btn-success inline-block" />
                <input type="reset" value="取消" class="btn btn-info inline-block" onclick="javascript :history.back(-1);" />
            </div>
        </div>
    </div>
</form>
