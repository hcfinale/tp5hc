<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:28:"./tpl\index\login\index.html";i:1538012000;}*/ ?>
<!DOCTYPE html>
...
<div class="mui-content">
    <form id='login-form' class="mui-input-group" method="post" action="<?php echo url('Login/index'); ?>">
        ...
        <!--<form class="mui-input-group" method="post" action="<?php echo url('Login/dologin'); ?>">-->
...
<script src="/public/index/js/mui.enterfocus.js"></script>
