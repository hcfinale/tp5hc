<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:28:"./tpl\admin\index\index.html";i:1541120214;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header" style="text-align: center;">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo \think\Session::get('user'); ?></strong></span>
                                <span class="text-muted text-xs block">超级管理员<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="<?php echo url('index/portrait'); ?>">修改头像</a>
                                </li>
                                <li><a class="J_menuItem" href="profile.html">个人资料</a>
                                </li>
                                <li><a class="J_menuItem" href="contacts.html">联系我们</a>
                                </li>
                                <li><a class="J_menuItem" href="<?php echo url('Aclcommon/cache'); ?>">清除缓存</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="<?php echo url('Aclcommon/logout'); ?>">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Index/info'); ?>" data-index="0">系统配置信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Index/ll'); ?>">读取配置文件</a>
                            </li>
                            <li>
                                <a href="<?php echo url('ShortMassage/note'); ?>" target="_blank">短信</a>
                            </li>
                            <li>
                                <a href="<?php echo url('Index/fun'); ?>" target="_blank">公共函数库</a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Column/lst'); ?>">栏目列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Column/addlist'); ?>">栏目添加</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Article/addArticle'); ?>">添加文章</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Article/lst'); ?>">所有文章</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Authority/lst'); ?>">权限列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Authority/addAuth'); ?>">权限添加</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">瀑布流</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Picture/addpic'); ?>">图片添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Picture/useDb'); ?>">瀑布流</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">获取地理位置</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('position/mark'); ?>">图片添加</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="<?php echo url('Aclcommon/logout'); ?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo url('Index/info'); ?>" frameborder="0" data-id="index_v2.html" seamless></iframe>
            </div>
            <div class="footer">
