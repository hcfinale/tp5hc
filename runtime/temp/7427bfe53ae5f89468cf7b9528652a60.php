<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:28:"./tpl\admin\login\index.html";i:1532943649;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="gray-bg">
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <h3>欢迎使用 H+</h3>
            <form class="m-t" role="form" action="<?php echo url('admin/login/index'); ?>" method="post">
